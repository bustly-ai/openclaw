...
description: >-
  This skill provides an advanced financial modeling suite with DCF analysis,
  sensitivity testing, Monte Carlo simulations, and scenario planning for
...
- Trigger condition: Triggered when the user explicitly requires the `creating-financial-models` capability.
