...
name: "Copywriting"
description: >-
  Write, rewrite, or improve marketing copy for any page with clear, compelling,
  and testable messaging while enforcing alignment, honesty, and conversion best
  practices.
status: enabled
layer: core
sub_layer: marketing
...
**User:** Write homepage copy for a project management tool aimed at freelancers who hate complicated software.

**Assistant:** Before I write, let me confirm the copy brief. Target: solo freelancers overwhelmed by enterprise PM tools. Core value prop: simple task tracking that stays out of your way. Primary CTA: "Start free -- no credit card." Traffic source and awareness level? Once you confirm, I will deliver headline options, full page copy, and CTA alternatives.

## Applicable Scenarios and Triggers
- Applicable scenarios: core/marketing related business tasks.
- Trigger condition: Triggered when the user explicitly requires the "copywriting" capability.
