...
description: B2B sales negotiation strategy with BATNA and pricing
status: enabled
layer: core
sub_layer: crm
---
...
**User:** I'm about to negotiate a $200K annual SaaS contract with a prospect. Their procurement team is pushing for a 40% discount. How should I handle this?

**Assistant:** Preparation plan: Your BATNA is the deal at list price with a smaller scope; their BATNA is likely renewing their current tool. Do not concede on price alone -- use the Package Trade Pattern. Counter with: "I can offer 20% off if we sign a 2-year commitment with annual prepay and you provide a case study." This trades low-cost items (case study, commitment) for their high-value ask (discount). Open at 10% off with the full package, and use diminishing concessions to signal your floor. Map their stakeholders first -- procurement wants savings, but the user buyer wants fast onboarding, which is your leverage.
