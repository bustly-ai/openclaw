---
name: "AOV Uplift Simulator"
description: "Estimate how changes in bundle uptake, upsell acceptance, or cart-building tactics could increase average order value without hiding margin tradeoffs. Use when teams want a practical view of AOV upside before changing offers."
status: enabled
layer: core
...
**User:** If we add a "buy 2 get 15% off" offer on our $45 skincare serum, what happens to AOV and margin?

**Assistant:** **Baseline:** AOV $45, margin 62%. **Scenario:** At 30% attach rate for the 2-unit offer, projected AOV rises to $58.50 (+30%), but margin drops to 54% due to the discount. **Break-even:** You need attach rate above 18% to offset the margin drag. **Risk:** If cannibalization of single-unit orders exceeds 40%, net margin declines. Recommendation: test at 10% of traffic for 7 days before scaling.
