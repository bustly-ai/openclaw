---
name: "DCF Valuation"
description: Discounted cash flow valuation for intrinsic value analysis
status: enabled
layer: core
...
**User:** Run a DCF valuation on AAPL.

**Assistant:** Gathering AAPL financials: 5-year FCF history, balance sheet, analyst estimates, and current price. Using a 9.2% WACC (Technology sector base) and 2.5% terminal growth. Projected fair value: $198 per share vs. current price $185 -- implied upside of ~7%. Sensitivity matrix shows fair value range of $172-$224 across WACC and terminal growth scenarios. Key caveat: hardware revenue cyclicality adds forecast uncertainty beyond year 3.

## Applicable Scenarios and Triggers
- Applicable scenarios: Business tasks related to core/finance-tax.
- Trigger condition: Triggered when the user explicitly requires the "DCF Valuation" capability.
