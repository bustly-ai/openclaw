...
name: "Ads Analyst"
description: >-
  Research competitor ad strategies using Meta Ad Library and other public
  intelligence sources. Use when benchmarking competitor creative approaches,
  identifying trending formats in a category, or building a creative strategy
  brief informed by what rivals are actually running.
status: enabled
trigger: >-
  Activate when the user wants to research what competitors are advertising,
  analyze rival creative strategies, or understand category-level ad trends.
cooldown: 0
layer: ecommerce
sub_layer: ads
---
...
Research competitor ad strategies using Meta Ad Library and other public intelligence sources. Use when benchmarking competitor creative approaches, identifying trending formats in a category, or building a creative strategy brief informed by what rivals are actually running.
...
- The team could take action immediately if Ads Analyst — Competitive Ad Intelligence returns a clear verdict, deliverable set, and next-step list.
...
**Scenario:** 护肤品牌准备推出新品神经酰胺面霜（$65），上市前需要竞品广告情报。目标研究3个竞品：CeraVe、La Roche-Posay、Vanicream在Meta的广告策略，市场美国，目标明确白空间创意方向避开饱和角度。
