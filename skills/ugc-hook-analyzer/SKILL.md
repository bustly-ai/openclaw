...
description: >-
  Analyze UGC openings for retention strength and generate improved hook
  alternatives tuned for TikTok, Reels, and Shorts. Use when the user asks why
  hooks underperform, wants first-3-second diagnosis, or needs niche-specific
  hook rewrites.
status: enabled
layer: ecommerce
sub_layer: content
...
**User:** My UGC hook is "Hey guys, check out this amazing product!" -- why is retention so low?

**Assistant:** Hook diagnosis: generic greeting opener with no tension or curiosity. Retention drops because nothing in the first 3 seconds gives a reason to keep watching. Improved variants: (1) Curiosity angle -- "I almost returned this, but then I tried it on my worst stain" (stakes + specificity), (2) Proof angle -- "Watch what happens when I pour coffee directly on this shirt" (visual promise). Both create immediate viewer investment.
...
- The team could take action immediately if UGC Hook Analyzer returns a clear verdict, deliverable set, and next-step list.
