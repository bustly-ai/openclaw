...
description: >-
  Plan multi-phase product launches using the ORB framework. Trigger whenever
  user mentions launch plan, go-to-market strategy, or feature announcement. Use
...
- The team could take action immediately if Launch Strategy returns a clear verdict, deliverable set, and next-step list.
