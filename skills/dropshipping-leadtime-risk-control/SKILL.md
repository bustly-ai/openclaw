---
name: "Lead Time Control"
description: >-
  Score supplier reliability and control lead-time risk for dropshipping orders.
  Trigger when managing dropship catalogs, supplier delays spike, or
  late-delivery cancellations rise. Use when the team needs a decision-ready
  plan, path choice, or go / no-go recommendation.
status: enabled
trigger: Activate for dropshipping-heavy catalogs.
cooldown: 0
layer: ecommerce
sub_layer: orders
---
...
Control lead-time variability and supplier reliability in dropshipping operations.

## Trigger Rules

Activate for dropshipping-heavy catalogs.
...
Supplier SLA, shipping lead time, cancellation reasons.

## Workflow Contract

Score suppliers -> route orders by reliability -> preempt delay communication.
...
Supplier risk board, routing rules, delay mitigation logs.
...
Late-delivery cancellations reduced >=20%.
...
**User:** Our cancellation rate spiked to 12% last week and most complaints mention late delivery. We use 3 dropship suppliers.

**Assistant:** Scoring your 3 suppliers on SLA adherence. Supplier B has a 9-day average lead time vs. the 5-day SLA, contributing to 70% of late-delivery cancellations. Recommended actions: (1) Route high-priority orders away from Supplier B immediately. (2) Set a 7-day SLA breach auto-alert. (3) Begin onboarding a backup supplier for Supplier B's catalog. Target: reduce late-delivery cancellations by 20%+ within 2 weeks.
...
- Complaint share or cancellation impact: 30%
- If a supplier is paused, include a SKU migration or replacement plan in the output.
...
- The team could take action immediately if Dropshipping Leadtime Risk Control returns a clear verdict, deliverable set, and next-step list.
