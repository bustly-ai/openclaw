...
|----------|-------------|--------------|
| **Chinese** | Microsoft YaHei / PingFang SC / Noto Sans CJK SC | SimSun, Heiti SC, Arial Unicode MS |
| **Japanese** | Yu Gothic / Hiragino Sans / Noto Sans CJK JP | Meiryo, Arial Unicode MS |
| **Korean** | Malgun Gothic / Apple SD Gothic Neo / Noto Sans CJK KR | NanumGothic, Arial Unicode MS |
| **English** | Aptos / Helvetica Neue / Arial | Georgia, Calibri, Cambria, Trebuchet MS |

- For mixed Chinese-English content: use Microsoft YaHei for Chinese, the chosen font for English
- Prefer `theme.fonts.display` and `theme.fonts.body` from the starter theme rather than hard-coding fonts in each slide module
...
```javascript
// Correct
slide.addText("Main Title", { bold: true, fontSize: 36, fontFace: theme.fonts.display });
slide.addText("Body text here.", { bold: false, fontSize: 14, fontFace: theme.fonts.body });
