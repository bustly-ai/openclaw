...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.sessions.visibility":
    'Controls which sessions can be targeted by sessions_list/sessions_history/sessions_send. ("agent" default = any session in the current agent id; "self" = only current; "tree" = current session + spawned subagent sessions; "all" = any session; cross-agent still requires tools.agentToAgent).',
