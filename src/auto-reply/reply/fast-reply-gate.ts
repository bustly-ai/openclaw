...
const FAST_REPLY_GATE_PROMPT = [
  ...
  `<IMPORTANT>Except for simple greetings or lightweight social niceties (for example: hi, hello, thanks, good morning), almost every user message should call the ${FAST_REPLY_GATE_TOOL_NAME} tool.</IMPORTANT>`,
